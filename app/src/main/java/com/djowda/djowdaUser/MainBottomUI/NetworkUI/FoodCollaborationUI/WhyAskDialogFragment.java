...
public class WhyAskDialogFragment extends DialogFragment {

    private MaterialButton dismissDialogButton;

    public WhyAskDialogFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_why_ask_dialog, container, false);
